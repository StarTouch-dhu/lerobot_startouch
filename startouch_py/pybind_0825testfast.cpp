...
PYBIND11_MODULE(startouch, m) {
    py::class_<ArmController>(m, "ArmController")
        ...
        // .def("gravity_compensation", &ArmController::gravity_compensation,"gravity_compensation fenable_fdunction. 回车键退出")
        .def("gravity_compensation", &ArmController::identify_gravity_compensation,"identify_gravity_compensation function. 回车键退出")        
